...
export const UPDATE_CHAPTER_NUMBER = 'UPDATE_CHAPTER_NUMBER';
export const CHANGE_DEFAULT_CHAPTER = 'CHANGE_DEFAULT_CHAPTER';
...
/** Session */
export const UPDATE_GROUP_AVENGERS = 'UPDATE_GROUP_AVENGERS';
export const FETCH_GROUP_AVENGERS = 'FETCH_GROUP_AVENGERS';
